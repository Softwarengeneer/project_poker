...
### Файлы
- poker_bot.exe - основная программа
- equity_cache.pickle - файл кэша (создается автоматически)
- screenshot_*.png - временные скриншоты (удаляются по завершенью программы)
